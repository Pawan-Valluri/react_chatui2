...
/* Thinking indicator — three smooth staggered circles suggesting reasoning flow */
export const BrainIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    {/* Lightbulb — universally understood as "thinking / idea" */}
...
/* Tool execution — wrench icon, universally understood as tools/settings */
...
/* App logo icon — clean lightning bolt (fast, intelligent, premium) */
export const SparklesIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M13 2L4.09 12.37A1 1 0 0 0 5 14h5.5l-1.5 8 9-10.37A1 1 0 0 0 17 10h-5l1-8z" />
  </svg>
);
